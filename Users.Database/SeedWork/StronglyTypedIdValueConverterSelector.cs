...
public class StronglyTypedIdValueConverterSelector : ValueConverterSelector
{
    ...
    public override IEnumerable<ValueConverterInfo> Select(Type modelClrType, Type providerClrType = null)
    {
        ...
        {
            var isTypedIdValue = typeof(UniqueIdBase).IsAssignableFrom(underlyingModelType);
            if (isTypedIdValue)
            {
                var converterType = typeof(UniqueIdValueConverter<>).MakeGenericType(underlyingModelType);
